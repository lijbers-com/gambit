      ...
      <div className="h-80 bg-gradient-to-br from-blue-50 to-gray-100 rounded-lg relative overflow-hidden">
        ...
        {data.map((store, index) => (
          ...
          >
            ...
            {/* Tooltip */}
            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 bg-neutral-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none">
