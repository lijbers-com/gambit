...
// EXACT OfflineInstore component from story/page-templates-campaign-overview--offline-instore
...
export default function OfflineInstoreCampaignsPage() {
  ...
  return (
    <AppLayout
      ...
      breadcrumbProps={{}}
      pageHeaderProps={{
        title: 'Campaigns - Offline Instore',
        subtitle: 'Monitor offline instore campaign performance and manage your advertising initiatives',
      ...
      <Card className="w-full">
        <CardHeader>
          <FilterBar
            ...
            searchValue={''}
            onSearchChange={() => {}}
            searchPlaceholder="Search offline instore campaigns..."
          />
        </CardHeader>
        <CardContent>
          <Table
