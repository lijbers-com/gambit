...
// EXACT SponsoredProducts component from story/page-templates-campaign-overview--sponsored-products
...
export default function SponsoredProductsCampaignsPage() {
  ...
  return (
    <AppLayout
      ...
      breadcrumbProps={{}}
      pageHeaderProps={{
        title: 'Campaigns - Sponsored Products',
        subtitle: 'Monitor sponsored products campaign performance and manage your advertising initiatives',
      ...
      <Card className="w-full">
        <CardHeader>
          <FilterBar
            ...
            searchValue={''}
            onSearchChange={() => {}}
            searchPlaceholder="Search sponsored products campaigns..."
          />
        </CardHeader>
        <CardContent>
          <Table
