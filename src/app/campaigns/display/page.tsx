...
// EXACT Display component from story/page-templates-campaign-overview--display
...
export default function DisplayCampaignsPage() {
  ...
  return (
    <AppLayout
      ...
      breadcrumbProps={{}}
      pageHeaderProps={{
        title: 'Campaigns - Display',
        subtitle: 'Monitor display campaign performance and manage your advertising initiatives',
