  ...
  workflows: [
    { id: 'WF-DMI', engine: 'digital-instore', name: 'Digital in-store — campaign lifecycle', status: 'published', updatedAt: now, publishedAt: now,
      ...
      steps: [
        ...
        { id: 'su-bookings', kind: 'fulfilment', name: 'Create bookings',  description: 'The guided setup walks through schedule, placement and delivery.', owner: 'advertiser', mandatory: true, setup: 'create-bookings', x: 40, y: 320, actions: [{ id: 'su-bookings-todo', type: 'todo', label: 'To-do: create bookings', to: 'advertiser' }] },
        ...
        { id: 'su-creatives', kind: 'fulfilment', name: 'Link creatives', description: 'The creative step of the setup wizard, for bookings still missing one.', owner: 'advertiser', mandatory: true, setup: 'link-creatives', x: 40, y: 600, actions: [{ id: 'su-creatives-todo', type: 'todo', label: 'To-do: link creatives', to: 'advertiser' }] },
    ...
    { id: 'WF-OMI', engine: 'offline-instore', name: 'Offline in-store — campaign lifecycle', status: 'published', updatedAt: now, publishedAt: now,
      ...
      steps: [
        ...
        { id: 'f-print',     kind: 'fulfilment',  name: 'Sent to print',            description: 'Printer instruction sent.',                      owner: 'retailer', mandatory: true, x: 680, y: 180, actions: [{ id: 'a12', type: 'log', label: 'Chat line: printer instruction sent' }] },
