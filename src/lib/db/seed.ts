...
export const seedData: DbData = {
  ...
  mediaPlans: [
    ...
    },
    {
      ...
      kpis: ['roas'], budget: 9700, autoBudget: true,
  ...
  bookings: [
    ...
    // Two bookings pacing far apart on purpose: the aisle screens sit on
    // budget they cannot use while the entrance screens are nearly capped —
    // the shape the booking-rebalance recommendation exists to catch.
    { id: 'B-026', campaignId: 'C-025', name: 'Aisle Screens — Summer',      status: 'running',   budget: 3000, spend: 880,  startDate: '2026-05-04', endDate: '2026-06-30', positionIds: ['pos-dis-aisle'],    creativeStatus: 'approved', createdAt: now, updatedAt: now },
    { id: 'B-031', campaignId: 'C-025', name: 'Entrance Screens — Summer',   status: 'running',   budget: 1500, spend: 1370, startDate: '2026-05-04', endDate: '2026-06-30', positionIds: ['pos-dis-entrance'], creativeStatus: 'approved', createdAt: now, updatedAt: now },
  ...
  mediaProducts: [
    ...
    // Digital in-store
    { id: 'mprod-dis-instore', engine: 'digital-instore', name: 'In-store screens', description: 'Digital screens in physical stores.', status: 'active', buyingModels: ['guaranteed'], pricingBasis: 'per-day', listPrice: 1800, holdDays: 7, constraints: ['Minimum run time 14 days', 'Creatives due X-4', 'Store list generated by Edge'], owner: 'Media Proposition Developer' },
    // Offline in-store
    { id: 'mprod-ois-print',   engine: 'offline-instore', name: 'Printed materials', description: 'Shelf displays, floor stickers, posters.', status: 'active', buyingModels: ['guaranteed'], pricingBasis: 'flat', listPrice: 4500, holdDays: 10, constraints: ['Minimum run time 14 days', 'Print files due X-8', 'Installed by Hamilton Bright'], owner: 'Media Proposition Developer' },
  ...
  // ── Placements ────────────────────────────────────────────────────────
  // Display and offsite group positions into placements; the other
  // propositions put positions straight under the product.
  placements: [
    { id: 'plc-dsp-home-atf',   mediaProductId: 'mprod-dsp-home', name: 'Above the fold',   description: 'What a shopper sees before scrolling.' },
    { id: 'plc-dsp-home-feed',  mediaProductId: 'mprod-dsp-home', name: 'In the feed',      description: 'Between the storefront rows.' },
    { id: 'plc-dsp-cat-top',    mediaProductId: 'mprod-dsp-cat',  name: 'Category header',  description: 'Above the listing.' },
    { id: 'plc-dsp-cat-list',   mediaProductId: 'mprod-dsp-cat',  name: 'In the listing',   description: 'Between and beside products.' },
    { id: 'plc-dsp-pdp-page',   mediaProductId: 'mprod-dsp-pdp',  name: 'On the page',      description: 'Around the product detail.' },
    { id: 'plc-dsp-pdp-basket', mediaProductId: 'mprod-dsp-pdp',  name: 'At the basket',    description: 'When the product goes in.' },
    { id: 'plc-off-web-std',    mediaProductId: 'mprod-off-display', name: 'Standard',      description: 'IAB standard sizes.' },
    { id: 'plc-off-web-hi',     mediaProductId: 'mprod-off-display', name: 'High impact',   description: 'Skins and takeovers.' },
  ],

  positions: [
    // Display onsite — a channel holds every slot on that page type.
    { id: 'pos-dsp-home-top',    mediaProductId: 'mprod-dsp-home', placementId: 'plc-dsp-home-atf',  name: 'Homepage top banner',       format: 'Billboard 970x250', dailyCapacity: 4, floorPrice: 15.6, listPrice: 2340 },
    { id: 'pos-dsp-home-mid',    mediaProductId: 'mprod-dsp-home', placementId: 'plc-dsp-home-feed',  name: 'Homepage mid banner',       format: 'Leaderboard 728x90', dailyCapacity: 6, floorPrice: 14.4, listPrice: 2510 },
    { id: 'pos-dsp-home-rail',   mediaProductId: 'mprod-dsp-home', placementId: 'plc-dsp-home-atf',  name: 'Homepage side rail',        format: 'Halfpage 300x600', dailyCapacity: 8, floorPrice: 17.2, listPrice: 2480 },
    { id: 'pos-dsp-home-native', mediaProductId: 'mprod-dsp-home', placementId: 'plc-dsp-home-feed',  name: 'Homepage native row',       format: 'Native card', dailyCapacity: 10, floorPrice: 13.0, listPrice: 2050 },
    { id: 'pos-dsp-home-hero',   mediaProductId: 'mprod-dsp-home', placementId: 'plc-dsp-home-atf',  name: 'Homepage hero takeover',    format: 'Takeover', dailyCapacity: 1, floorPrice: 20.4, listPrice: 2460 },
    { id: 'pos-dsp-cat-top',     mediaProductId: 'mprod-dsp-cat', placementId: 'plc-dsp-cat-top',   name: 'Category top banner',       format: 'Billboard 970x250', dailyCapacity: 8, floorPrice: 16.2, listPrice: 2080 },
    { id: 'pos-dsp-cat-inline',  mediaProductId: 'mprod-dsp-cat', placementId: 'plc-dsp-cat-list',   name: 'Category inline banner',    format: 'Leaderboard 728x90', dailyCapacity: 12, floorPrice: 11.8, listPrice: 2170 },
    { id: 'pos-dsp-cat-rail',    mediaProductId: 'mprod-dsp-cat', placementId: 'plc-dsp-cat-list',   name: 'Category side rail',        format: 'Halfpage 300x600', dailyCapacity: 10, floorPrice: 15.0, listPrice: 2250 },
    { id: 'pos-dsp-cat-footer',  mediaProductId: 'mprod-dsp-cat', placementId: 'plc-dsp-cat-list',   name: 'Category footer banner',    format: 'Leaderboard 728x90', dailyCapacity: 14, floorPrice: 9.6, listPrice: 1890 },
    { id: 'pos-dsp-pdp',         mediaProductId: 'mprod-dsp-pdp', placementId: 'plc-dsp-pdp-page',   name: 'PDP banner',                format: 'Leaderboard 728x90', dailyCapacity: 12, floorPrice: 15.8, listPrice: 2070 },
    { id: 'pos-dsp-pdp-related', mediaProductId: 'mprod-dsp-pdp', placementId: 'plc-dsp-pdp-page',   name: 'PDP related products',      format: 'Native card', dailyCapacity: 18, floorPrice: 12.2, listPrice: 1830 },
    { id: 'pos-dsp-pdp-gallery', mediaProductId: 'mprod-dsp-pdp', placementId: 'plc-dsp-pdp-page',   name: 'PDP gallery slot',          format: 'Rich media', dailyCapacity: 6, floorPrice: 16.4, listPrice: 2360 },
    { id: 'pos-dsp-pdp-basket',  mediaProductId: 'mprod-dsp-pdp', placementId: 'plc-dsp-pdp-basket',   name: 'Add-to-basket overlay',     format: 'Overlay 300x250', dailyCapacity: 9, floorPrice: 14.6, listPrice: 2190 },
    // Sponsored products
    ...
    { id: 'pos-off-web-standard', mediaProductId: 'mprod-off-display', placementId: 'plc-off-web-std',    name: 'Open web display',      format: 'MPU 300x250', dailyCapacity: 100, floorPrice: 2, listPrice: 150 },
    { id: 'pos-off-web-hpa',      mediaProductId: 'mprod-off-display', placementId: 'plc-off-web-hi',    name: 'High-impact takeover',  format: 'Skin + billboard', dailyCapacity: 15, floorPrice: 11.0, listPrice: 1800 },
    { id: 'pos-off-web-native',   mediaProductId: 'mprod-off-display', placementId: 'plc-off-web-std',    name: 'Native in-feed',        format: 'Native card', dailyCapacity: 80, floorPrice: 2, listPrice: 150 },
  ...
  creativeTemplates: [
    // Display
    // The production display app's template list, in its own order. The
    // Hero banner mirrors the live form field for field; the others share
    // the fields the display app asks of every creative (click URL, alt
    // text, sponsored label, DV script) plus what their layout needs.
    { id: 'tpl-dis-super-skinny', engine: 'display', name: 'Super Skinny Banner', description: 'A slim strip between content blocks — headline and CTA, nothing more.', sizes: ['1376x80', '375x60'], preview: 'banner',
      fields: [
        ...
        { key: 'mobileImage', label: '(Mobile) image — 375x60', type: 'image', hint: 'Select an image for mobile devices to be shown' },
        { key: 'desktopImage', label: '(Desktop) image — 1376x80', type: 'image', hint: 'Select an image to be shown on desktop devices' },
      ],
      fileHint: 'PNG or JPG, RGB. One line of text — there is no room for body copy.' },
    { id: 'tpl-dis-video', engine: 'display', name: 'Standard Video Banner', description: 'The standard banner slot, with an autoplay video instead of a still.', sizes: ['1376x344', '375x200'], preview: 'video',
      fields: [
        { key: 'header', label: 'Headline', type: 'text', required: true, placeholder: 'Headline', maxLength: 44, localized: true, hint: 'Fill in a headline' },
        { key: 'cta', label: 'CTA', type: 'select', options: ['Get Offer', 'Shop now', 'Discover', 'Order now', 'Learn more'], hint: 'Select the Call to Action from the list' },
        { key: 'bgColor', label: 'Background color', type: 'select', options: ['Black', 'White', 'Blue', 'Green', 'Orange'], hint: 'Select the background color from the list' },
        ...
        { key: 'sponsoredLabel', label: 'Show sponsored label', type: 'select', options: ['Yes', 'No'], hint: 'Show the sponsored label' },
        { key: 'dvScript', label: 'DV script', type: 'text', hint: 'Enter the DV script src to be used. Make sure to not add any HTML tags.' },
        { key: 'videoFile', label: 'Video file', type: 'image', required: true, hint: 'MP4 H.264, max 15s, sound off by default' },
        { key: 'bannerImage', label: 'Poster frame', type: 'image', hint: 'Shown before the video plays and where autoplay is off' },
      ],
      fileHint: 'MP4 H.264, max 15s, sound off by default. Poster frame PNG or JPG at the slot size.' },
    { id: 'tpl-dis-standard', engine: 'display', name: 'Standard Banner', description: 'The standard content-page banner — headline, body copy and CTA, per device.', sizes: ['1376x344', '375x200'], preview: 'banner',
      fields: [
        { key: 'header', label: 'Headline', type: 'text', required: true, placeholder: 'Headline', maxLength: 44, localized: true, hint: 'Fill in a headline' },
        ...
        { key: 'desktopImage', label: '(Desktop) image — 1376x344', type: 'image', hint: 'Select an image to be shown on desktop devices' },
      ],
      fileHint: 'PNG or JPG, RGB. Mobile 375x200; desktop fills the banner slot.' },
    { id: 'tpl-dis-small-tile', engine: 'display', name: 'Small Tile Banner', description: 'A single tile in the product grid — one image, one line, one CTA.', sizes: ['328x328'], preview: 'banner',
      fields: [
        { key: 'header', label: 'Headline', type: 'text', required: true, placeholder: 'Headline', maxLength: 44, localized: true, hint: 'Fill in a headline' },
        { key: 'cta', label: 'CTA', type: 'select', options: ['Get Offer', 'Shop now', 'Discover', 'Order now', 'Learn more'], hint: 'Select the Call to Action from the list' },
        { key: 'bgColor', label: 'Background color', type: 'select', options: ['Black', 'White', 'Blue', 'Green', 'Orange'], hint: 'Select the background color from the list' },
        ...
        { key: 'sponsoredLabel', label: 'Show sponsored label', type: 'select', options: ['Yes', 'No'], hint: 'Show the sponsored label' },
        { key: 'dvScript', label: 'DV script', type: 'text', hint: 'Enter the DV script src to be used. Make sure to not add any HTML tags.' },
        { key: 'bannerImage', label: 'Image — 328x328', type: 'image', required: true, hint: 'Select the tile image' },
      ],
      fileHint: 'PNG or JPG, square. Keep the subject inside the middle 80%.' },
    { id: 'tpl-dis-native-standard', engine: 'display', name: 'Native Standard Banner', description: 'The standard banner in the shop’s own look, with product tiles pulled from the catalogue.', sizes: ['1376x344', '375x200'], preview: 'banner',
      fields: [
        { key: 'header', label: 'Headline', type: 'text', required: true, placeholder: 'Headline', maxLength: 44, localized: true, hint: 'Fill in a headline' },
        { key: 'bodyCopy', label: 'Body copy', type: 'text', placeholder: 'Body copy', maxLength: 80, localized: true, hint: 'Set the content of the body copy' },
        { key: 'cta', label: 'CTA', type: 'select', options: ['Get Offer', 'Shop now', 'Discover', 'Order now', 'Learn more'], hint: 'Select the Call to Action from the list' },
        ...
        { key: 'sponsoredLabel', label: 'Show sponsored label', type: 'select', options: ['Yes', 'No'], hint: 'Show the sponsored label' },
        { key: 'dvScript', label: 'DV script', type: 'text', hint: 'Enter the DV script src to be used. Make sure to not add any HTML tags.' },
        { key: 'productId1', label: 'Product ID 1', type: 'text', width: 'half', hint: 'Enter 1st product tile product ID' },
        { key: 'productId2', label: 'Product ID 2', type: 'text', width: 'half', hint: 'Enter 2nd product tile product ID' },
        { key: 'productId3', label: 'Product ID 3', type: 'text', width: 'half', hint: 'Enter 3rd product tile product ID' },
        { key: 'productId4', label: 'Product ID 4', type: 'text', width: 'half', hint: 'Enter 4th product tile product ID' },
        { key: 'mobileImage', label: '(Mobile) image — 375x200', type: 'image', hint: 'Select an image for mobile devices to be shown' },
        { key: 'desktopImage', label: '(Desktop) image — 1376x344', type: 'image', hint: 'Select an image to be shown on desktop devices' },
      ],
      fileHint: 'PNG or JPG, RGB. Product tiles render from the product IDs; the image sits behind them.' },
    { id: 'tpl-dis-native-small-tile', engine: 'display', name: 'Native Small Tile Banner', description: 'A product-grid tile in the shop’s own look, built around one product.', sizes: ['328x328'], preview: 'banner',
      fields: [
        { key: 'header', label: 'Headline', type: 'text', required: true, placeholder: 'Headline', maxLength: 44, localized: true, hint: 'Fill in a headline' },
        { key: 'cta', label: 'CTA', type: 'select', options: ['Get Offer', 'Shop now', 'Discover', 'Order now', 'Learn more'], hint: 'Select the Call to Action from the list' },
        { key: 'clickUrl', label: 'Click URL', type: 'text', required: true, placeholder: '/…', hint: 'Fill in the URL where the user should be redirected to' },
      ...
      fileHint: 'PNG or JPG, square. The product tile renders from the product ID.' },
    { id: 'tpl-dis-large-tile', engine: 'display', name: 'Large tile Banner', description: 'A double-width tile in the product grid — room for body copy.', sizes: ['680x328', '375x200'], preview: 'banner',
      fields: [
        { key: 'header', label: 'Headline', type: 'text', required: true, placeholder: 'Headline', maxLength: 44, localized: true, hint: 'Fill in a headline' },
        { key: 'bodyCopy', label: 'Body copy', type: 'text', placeholder: 'Body copy', maxLength: 80, localized: true, hint: 'Set the content of the body copy' },
        { key: 'cta', label: 'CTA', type: 'select', options: ['Get Offer', 'Shop now', 'Discover', 'Order now', 'Learn more'], hint: 'Select the Call to Action from the list' },
        ...
        { key: 'dvScript', label: 'DV script', type: 'text', hint: 'Enter the DV script src to be used. Make sure to not add any HTML tags.' },
        { key: 'mobileImage', label: '(Mobile) image — 375x200', type: 'image', hint: 'Select an image for mobile devices to be shown' },
        { key: 'desktopImage', label: '(Desktop) image — 680x328', type: 'image', hint: 'Select an image to be shown on desktop devices' },
      ],
      fileHint: 'PNG or JPG, RGB. Spans two grid columns on desktop; one on mobile.' },
    { id: 'tpl-dis-key-web', engine: 'display', name: 'Key Web', description: 'The key visual on the web landing page — the biggest canvas in the shop.', sizes: ['1376x600', '375x400'], preview: 'banner',
      fields: [
        { key: 'header', label: 'Headline', type: 'text', required: true, placeholder: 'Headline', maxLength: 44, localized: true, hint: 'Fill in a headline' },
        { key: 'bodyCopy', label: 'Body copy', type: 'text', placeholder: 'Body copy', maxLength: 80, localized: true, hint: 'Set the content of the body copy' },
        { key: 'cta', label: 'CTA', type: 'select', options: ['Get Offer', 'Shop now', 'Discover', 'Order now', 'Learn more'], hint: 'Select the Call to Action from the list' },
        ...
        { key: 'sponsoredLabel', label: 'Show sponsored label', type: 'select', options: ['Yes', 'No'], hint: 'Show the sponsored label' },
        { key: 'dvScript', label: 'DV script', type: 'text', hint: 'Enter the DV script src to be used. Make sure to not add any HTML tags.' },
        { key: 'mobileImage', label: '(Mobile) image — 375x400', type: 'image', hint: 'Select an image for mobile devices to be shown' },
        { key: 'desktopImage', label: '(Desktop) image — 1376x600', type: 'image', hint: 'Select an image to be shown on desktop devices' },
      ],
      fileHint: 'PNG or JPG, RGB. Desktop 1376x600; mobile 375x400. Safe area: keep text out of the bottom 15%.' },
    { id: 'tpl-dis-hero', engine: 'display', name: 'Hero banner', description: 'The homepage hero — headline, body copy and product tiles, per device.', sizes: ['1376x344', '375x200'], preview: 'banner',
      fields: [
        ...
        { key: 'productId3', label: 'Product ID 3', type: 'text', width: 'half', hint: 'Enter 3rd product tile product ID' },
        { key: 'productId4', label: 'Product ID 4', type: 'text', width: 'half', hint: 'Enter 4th product tile product ID' },
        { key: 'productId5', label: 'Product ID 5', type: 'text', width: 'half', hint: 'Enter 5th product tile product ID' },
        { key: 'productId6', label: 'Product ID 6', type: 'text', width: 'half', hint: 'Enter 6th product tile product ID' },
        { key: 'mobileImage', label: '(Mobile) image — 375x200', type: 'image', hint: 'Select an image for mobile devices to be shown' },
    ...
    { id: 'tpl-dis-empty', engine: 'display', name: 'Empty Template', description: 'No layout logic — supply the finished artwork per device and where it clicks to.', sizes: ['1376x344', '375x200'], preview: 'banner',
      fields: [
        { key: 'clickUrl', label: 'Click URL', type: 'text', required: true, placeholder: '/…', hint: 'Fill in the URL where the user should be redirected to' },
        { key: 'altText', label: 'Alt text', type: 'text', required: true, hint: 'Fill in an alt text for the image' },
        { key: 'sponsoredLabel', label: 'Show sponsored label', type: 'select', options: ['Yes', 'No'], hint: 'Show the sponsored label' },
        { key: 'dvScript', label: 'DV script', type: 'text', hint: 'Enter the DV script src to be used. Make sure to not add any HTML tags.' },
        { key: 'mobileImage', label: '(Mobile) image', type: 'image', required: true, hint: 'Finished artwork for mobile devices' },
        { key: 'desktopImage', label: '(Desktop) image', type: 'image', required: true, hint: 'Finished artwork for desktop devices' },
      ],
      fileHint: 'PNG, JPG or GIF at the exact slot size. The artwork is placed as-is; nothing is drawn on top.' },
    // Digital in-store
  ...
  creatives: [
    ...
    { id: 'CR-101', name: 'Zero Sugar — Standard banner', engine: 'display', templateId: 'tpl-dis-standard', status: 'approved',
      values: { header: 'Zero sugar. All summer.', bodyCopy: 'Ice cold, zero sugar, all taste.', 'nl:header': 'Nul suiker. De hele zomer.', 'nl:bodyCopy': 'IJskoud, nul suiker, alle smaak.', cta: 'Shop now', bgColor: 'Blue', clickUrl: '/zero-sugar', altText: 'Zero sugar cola bottles on ice', sponsoredLabel: 'Yes' },
      languages: ['en', 'nl'], bookingIds: ['B-002'], createdAt: now, updatedAt: now },
    { id: 'CR-102', name: 'Holiday — Key web', engine: 'display', templateId: 'tpl-dis-key-web', status: 'approved',
      values: { header: 'The holidays start here', bodyCopy: 'Everything for the festive table, delivered.', cta: 'Discover', bgColor: 'Black', clickUrl: '/holidays', altText: 'Festive table with holiday dishes', sponsoredLabel: 'Yes' },
    ...
    { id: 'CR-108', name: 'Ice Cream — Search video', engine: 'display', templateId: 'tpl-dis-video', status: 'in-review',
      values: { header: 'Summer, served', cta: 'Learn more', bgColor: 'Blue', clickUrl: '/ice-cream', altText: 'Ice cream cones in the sun', sponsoredLabel: 'No' }, languages: ['en'], bookingIds: [], createdAt: now, updatedAt: now },
  ...
  // ── Pricing rules ─────────────────────────────────────────────────────
  // Indexes on the list price: the season, the moment, the market, the
  // demand, and the booking itself. Stacked in priority order.
  pricingRules: [
    { id: 'PR-001', name: 'Q4 season',                 kind: 'seasonality',   engine: 'all',                index: 1.25, from: '2026-10-01', to: '2026-12-31', description: 'The last quarter carries the year — every proposition prices up.', priority: 10, status: 'active', updatedAt: now },
    { id: 'PR-002', name: 'Summer dip',                kind: 'seasonality',   engine: 'all',                index: 0.9,  from: '2026-07-01', to: '2026-08-15', description: 'Holiday weeks: fill rate drops, so does the index.',           priority: 10, status: 'active', updatedAt: now },
    { id: 'PR-003', name: 'Black Friday week',         kind: 'moment',        engine: 'display',            index: 1.4,  from: '2026-11-23', to: '2026-11-29', description: 'The busiest week on site.',                                  priority: 20, status: 'active', updatedAt: now },
    { id: 'PR-004', name: 'Back to school',            kind: 'moment',        engine: 'sponsored-products', index: 1.15, from: '2026-08-17', to: '2026-09-06', description: 'Search demand for school categories.',                        priority: 20, status: 'active', updatedAt: now },
    { id: 'PR-005', name: 'Beer & soft drinks market', kind: 'market',        engine: 'sponsored-products', index: 1.2,  description: 'What the category commands in the market — reviewed quarterly against benchmarks.', priority: 30, status: 'active', updatedAt: now },
    { id: 'PR-006', name: 'High demand',               kind: 'demand',        engine: 'all',                index: 1.15, minFillRate: 0.8, description: 'When a position is 80% booked the remaining slots price up — hotel style.', priority: 40, status: 'active', updatedAt: now },
    { id: 'PR-007', name: 'Nearly sold out',           kind: 'demand',        engine: 'all',                index: 1.3,  minFillRate: 0.95, description: 'The last slots on a position.',                                 priority: 41, status: 'active', updatedAt: now },
    { id: 'PR-008', name: 'Early booking',             kind: 'early-booking', engine: 'all',                index: 0.92, minDaysAhead: 60, description: 'Booked two months ahead, 8% off — inventory certainty is worth something.', priority: 50, status: 'active', updatedAt: now },
    { id: 'PR-009', name: 'Volume deal',               kind: 'volume',        engine: 'all',                index: 0.95, minBudget: 25000, description: 'Bookings from €25,000 take 5% off.', priority: 60, status: 'active', updatedAt: now },
    { id: 'PR-010', name: 'CTV launch pricing',        kind: 'market',        engine: 'offsite',            mediaProductIds: ['mprod-off-ctv'], index: 0.85, description: 'Introductory index while the CTV product builds a track record.', priority: 30, status: 'draft', updatedAt: now },
  ],

  // ── Inventory holds ───────────────────────────────────────────────────
  // Bookings in review hold their positions at the price that stood when
  // they were booked, until the product's hold days run out.
  inventoryHolds: [
    { id: 'IH-001', bookingId: 'B-009', positionId: 'pos-dis-entrance',    from: '2026-06-08', to: '2026-08-15', units: 2,  priceLocked: 1800, heldAt: '2026-09-14T09:00:00.000Z', expiresAt: '2026-09-21T09:00:00.000Z', status: 'held' },
    { id: 'IH-002', bookingId: 'B-010', positionId: 'pos-off-web-standard', from: '2026-06-08', to: '2026-08-15', units: 20, priceLocked: 6,    heldAt: '2026-09-15T10:30:00.000Z', expiresAt: '2026-09-20T10:30:00.000Z', status: 'held' },
    { id: 'IH-003', bookingId: 'B-012', positionId: 'pos-dsp-pdp',          from: '2026-07-01', to: '2026-08-31', units: 4,  priceLocked: 10.8, heldAt: '2026-09-13T14:00:00.000Z', expiresAt: '2026-09-16T14:00:00.000Z', status: 'expired' },
    { id: 'IH-004', bookingId: 'B-014', positionId: 'pos-sp-search-top',    from: '2026-08-10', to: '2026-09-10', units: 1,  priceLocked: 0.83, heldAt: '2026-09-15T08:00:00.000Z', expiresAt: '2026-09-18T08:00:00.000Z', status: 'held' },
    { id: 'IH-005', bookingId: 'B-018', positionId: 'pos-ois-floor',        from: '2026-09-01', to: '2026-09-30', units: 3,  priceLocked: 4500, heldAt: '2026-09-10T11:00:00.000Z', expiresAt: '2026-09-20T11:00:00.000Z', status: 'held' },
    { id: 'IH-006', bookingId: 'B-005', positionId: 'pos-dsp-home-hero',    from: '2026-06-01', to: '2026-06-30', units: 1,  priceLocked: 17.5, heldAt: '2026-05-20T09:00:00.000Z', expiresAt: '2026-05-25T09:00:00.000Z', status: 'confirmed' },
  ],
  ...
  workflows: [
    { id: 'WF-DMI', engine: 'digital-instore', name: 'Digital in-store — campaign lifecycle', status: 'published', updatedAt: now, publishedAt: now,
      ...
      steps: [
        ...
        { id: 'su-campaign', kind: 'approval',   name: 'Review campaign', description: 'Check what the media plan proposed — name, budget, run time and type.', owner: 'advertiser', mandatory: true, setup: 'approve-campaign', x: 40, y: 180,  actions: [{ id: 'su-campaign-todo', type: 'todo', label: 'To-do: review campaign', to: 'advertiser' }] },
        { id: 'su-bookings', kind: 'todo', name: 'Create bookings',  description: 'The guided setup walks through schedule, placement and delivery.', owner: 'advertiser', mandatory: true, setup: 'create-bookings', x: 40, y: 320, actions: [{ id: 'su-bookings-todo', type: 'todo', label: 'To-do: create bookings', to: 'advertiser' }] },
        { id: 'su-approve',  kind: 'approval',   name: 'Review bookings', description: 'Check the prefilled bookings and mark them reviewed.', owner: 'advertiser', mandatory: true, setup: 'approve-bookings', x: 40, y: 460, actions: [{ id: 'su-approve-todo', type: 'todo', label: 'To-do: review bookings', to: 'advertiser' }] },
        { id: 'su-creatives', kind: 'todo', name: 'Link creatives', description: 'The creative step of the setup wizard, for bookings still missing one.', owner: 'advertiser', mandatory: true, setup: 'link-creatives', x: 40, y: 600, actions: [{ id: 'su-creatives-todo', type: 'todo', label: 'To-do: link creatives', to: 'advertiser' }] },
        ...
        { id: 's-approve',   kind: 'approval',     name: 'Approve booking',    description: 'AdOps approves; inventory goes from option to booked.', owner: 'retailer',   mandatory: true,  x: 360, y: 180, slaDays: 2, escalateTo: 'retailer', deputy: 'Campaign manager on duty', actions: [{ id: 'a3', type: 'email', label: 'Email the advertiser: booking approved', to: 'advertiser' }, { id: 'a4', type: 'set-status', label: 'Inventory: booked' }] },
        { id: 's-changes',   kind: 'notification', name: 'Changes requested',  description: 'Back to the advertiser with itemised reasons.',     owner: 'advertiser', mandatory: false, x: 360, y: 320, actions: [{ id: 'a5', type: 'email', label: 'Email the advertiser what to change', to: 'advertiser' }] },
        { id: 's-creative',  kind: 'check',        name: 'Creatives approved', description: 'Requested at approval; due X-4; approval logic lives in the engine.', owner: 'advertiser', mandatory: true, x: 360, y: 460, dueDaysBeforeStart: 4, slaDays: 2, escalateTo: 'retailer', actions: [{ id: 'a6', type: 'email', label: 'Email the advertiser the upload link', to: 'advertiser' }, { id: 'a7', type: 'todo', label: 'To-do: upload creatives per format', to: 'advertiser' }] },
        { id: 's-stores',    kind: 'check',        name: 'Screens targeted',   description: 'Store list and screen list generated — automatic.', owner: 'edge',      mandatory: true,  x: 360, y: 600, actions: [{ id: 'a8', type: 'kafka', label: 'Publish store list to the DMI engine' }] },
    ...
    { id: 'WF-OMI', engine: 'offline-instore', name: 'Offline in-store — campaign lifecycle', status: 'published', updatedAt: now, publishedAt: now,
      ...
      steps: [
        ...
        { id: 'c-brief',     kind: 'check',       name: 'Briefing sent to advertiser', description: 'Manual; may also happen in the sales phase.', owner: 'retailer', mandatory: true, x: 360, y: 180, actions: [{ id: 'a3', type: 'kafka', label: 'Send briefing to the Kafka topic' }, { id: 'a4', type: 'log', label: 'Chat line: briefing sent' }] },
        { id: 'c-creative',  kind: 'check',       name: 'Creative received & checked', description: 'Due X-4. The creative portal makes this derived.', owner: 'advertiser', mandatory: true, x: 360, y: 320, dueDaysBeforeStart: 4, slaDays: 2, escalateTo: 'retailer', actions: [{ id: 'a5', type: 'email', label: 'Email the advertiser the upload link', to: 'advertiser' }, { id: 'a6', type: 'log', label: 'Chat line: creatives added' }] },
        { id: 'c-products',  kind: 'check',       name: 'Retail products assigned', description: 'Automatic.',                                  owner: 'edge',     mandatory: true, x: 360, y: 460, actions: [{ id: 'a7', type: 'kafka', label: 'Publish products to the OMI engine' }] },
        { id: 'c-stores',    kind: 'check',       name: 'Store list generated',     description: 'Automatic (DLL in place, AH in progress).',       owner: 'edge',     mandatory: true, x: 360, y: 600, actions: [{ id: 'a8', type: 'kafka', label: 'Publish store list to the OMI engine' }] },
        { id: 'c-printer',   kind: 'check',       name: 'Printer approval received', description: 'Automatic, any time during preparation.',     owner: 'external', mandatory: true, x: 360, y: 740, actions: [{ id: 'a9', type: 'log', label: 'Chat line: printer approved' }] },
        { id: 's-signoff',   kind: 'approval',    name: 'Preparation done',         description: 'AdOps sign-off; the button is enabled only when all five checks are yes.', owner: 'retailer', mandatory: true, x: 360, y: 880, deputy: 'Second AdOps', slaDays: 1, escalateTo: 'retailer', actions: [{ id: 'a10', type: 'set-status', label: 'Booking: production' }] },
        { id: 's-delay',     kind: 'notification', name: 'Delay',                   description: 'Derived to-do: past X-4 without Done.',          owner: 'retailer', mandatory: false, x: 360, y: 1020, actions: [{ id: 'a11', type: 'todo', label: 'To-do: creatives overdue — chase the advertiser', to: 'retailer' }] },
        { id: 's-production', kind: 'stage',      name: 'Production',               description: 'X-4 → X. Print and distribution, external.',      owner: 'external', mandatory: true, x: 680, y: 40, actions: [] },
        { id: 'f-print',     kind: 'todo',  name: 'Sent to print',            description: 'Printer instruction sent.',                      owner: 'retailer', mandatory: true, x: 680, y: 180, actions: [{ id: 'a12', type: 'log', label: 'Chat line: printer instruction sent' }] },
    ...
    { id: 'WF-SP', engine: 'sponsored-products', name: 'Sponsored products — campaign lifecycle', status: 'draft', updatedAt: now,
      ...
      steps: [
        ...
        { id: 'su-bookings', kind: 'todo', name: 'Create bookings',  description: 'The guided setup walks through schedule, placement and delivery.', owner: 'advertiser', mandatory: true, setup: 'create-bookings', x: 40, y: 320, actions: [{ id: 'su-bookings-todo', type: 'todo', label: 'To-do: create bookings', to: 'advertiser' }] },
        { id: 'su-approve',  kind: 'approval',   name: 'Review bookings', description: 'Check the prefilled bookings and mark them reviewed.', owner: 'advertiser', mandatory: true, setup: 'approve-bookings', x: 40, y: 460, actions: [{ id: 'su-approve-todo', type: 'todo', label: 'To-do: review bookings', to: 'advertiser' }] },
        { id: 'su-targeting', kind: 'todo', name: 'Add products and keywords', description: 'Part of the booking setup — target the right products and terms.', owner: 'advertiser', mandatory: true, setup: 'add-targeting', x: 40, y: 600, actions: [{ id: 'su-targeting-todo', type: 'todo', label: 'To-do: add products and keywords', to: 'advertiser' }] },
    ...
    { id: 'WF-OFF', engine: 'offsite', name: 'Offsite — campaign lifecycle', status: 'draft', updatedAt: now,
      ...
      steps: [
        ...
        { id: 's-approve', kind: 'approval',   name: 'Approve booking',  description: 'AdOps approves audience and budget.',              owner: 'retailer',   mandatory: true, x: 360, y: 180, slaDays: 2, escalateTo: 'retailer', actions: [{ id: 'a2', type: 'email', label: 'Email the advertiser: booking approved', to: 'advertiser' }] },
    ...
    { id: 'WF-MP', engine: 'media-plan', name: 'Media plan — lifecycle', status: 'published', updatedAt: now, publishedAt: now,
      ...
      steps: [
        ...
        { id: 'su-campaigns', kind: 'todo', name: 'Add campaigns', description: 'One campaign per proposition the plan buys.', owner: 'advertiser', mandatory: true, setup: 'add-campaigns', x: 40, y: 180, actions: [] },
        ...
        { id: 'su-bookings', kind: 'todo', name: 'Create bookings', description: 'Every campaign has its bookings.', owner: 'advertiser', mandatory: true, setup: 'create-bookings', x: 40, y: 460, actions: [] },
        { id: 'su-creatives', kind: 'todo', name: 'Link creatives', description: 'Every booking has a creative linked.', owner: 'advertiser', mandatory: true, setup: 'link-creatives', x: 40, y: 600, actions: [] },
